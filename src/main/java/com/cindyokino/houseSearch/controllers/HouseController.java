...
public class HouseController {
	...
	House house1 = new House(14158660L, 288800d, "2000, Rue Jean-Béliveau", "Longueuil (Le Vieux-Longueuil)", "Quartier Centre", LocalDate.now(), LocalDate.now());
	House house2 = new House(13262772L, 1120000d, "864, boulevard Queen", "Saint-Lambert (Montérégie)", null, LocalDate.now(), LocalDate.now());
